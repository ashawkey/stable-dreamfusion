...
if __name__ == '__main__':
    ...
    parser.add_argument('--dont_recenter', action='store_true', help="dont recenter, helpful for multiview zero123")
    parser.add_argument('--dont_resize', action='store_true', help="dont resize")
